        ...
        <div className='w-full h-[680x]'>
            <form onSubmit={handleSubmit} className='border rounded-xl border-gray-300 p-10 mx-auto mt-5 w-[540px] h-[450px]'>
                ...
                <div className="relative z-0 w-full mb-6 mt-10 group text-lg">
                    <input type="email" name="email" id="email" className="block py-2.5 px-0 w-full text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                ...
                <div className="mt-9 relative nameContainer">
                    ...
                    <div className="relative z-0 w-full group text-lg">
                    {
                        ...
                        <input onChange={handledPassword} type={show ? "text" : "password"} name="password" id="password" value={password} className="block py-2.5 px-0 w-full text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
