...
const Blog = () => {
    ...
    return (
        <div className='p-20'>
            <button className='btn btn-warning block ml-auto ' onClick={generatePEF} type='primary'>Generate PDF</button>

            <div id="container" className=' mx-auto w-[600px] flex flex-col gap-10'>
                <div className='px-5'>
