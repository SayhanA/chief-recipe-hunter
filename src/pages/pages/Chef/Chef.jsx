            ...
            <div className='h-[600px] lg:h-[760px] bg-[url("/styleimg/cat-han-W_5Eakb1598-unsplash.jpg")] bg-no-repeat bg-cover' >
                <div className='w-full h-full bg-gradient-to-r from-[#00000080] to-[#00000010] grid lg:grid-cols-2 relative'>
                    ...
                    <div className='relative'>
                        <img className='hidden lg:block absolute left-0' src="/public/styleimg/landing-slide-1-img-10.png" alt="" />
                        <img className='hidden lg:block absolute bottom-0 left-40' src="/public/styleimg/landing-slide-1-img-3.png" alt="" />
                        <img className='hidden lg:block absolute right-20 top-20' src="/public/styleimg/landing-slide-1-img-6.png" alt="" />
                        <img className='hidden lg:block absolute top-[50%] left-20' src="/public/styleimg/landing-slide-1-img-7.png" alt="" />
                        <img className='hidden lg:block absolute top-[30%] left-[350px] w-[200px]' src="/public/styleimg/nuts.png" alt="" />
                        <img className='hidden lg:block absolute top-0 left-80 w-[200px]' src="/public/styleimg/nuts.png" alt="" />
                        <img className='hidden lg:block absolute bottom-20 right-0 w-[200px]' src="/public/styleimg/nuts.png" alt="" />
                        <img className='absolute w-[200px] lg:w-[450px] lg:-left-[400px] -top-52 lg:top-[30%]' src="/public/styleimg/welcome.png" alt="" />
